    ...
    return (
        ...
        <tbody>
            <tr>
                ...
                <td style={{ border: "1px solid black", backgroundColor: "aliceblue", color: "blue"}}>+100,000원</td>
            ...
            <tr>
                ...
                <td style={{ border: "1px solid black", backgroundColor: "aliceblue"}}>-</td>
                <td style={{ border: "1px solid black", backgroundColor: "aliceblue"}}>-</td>
                <td style={{ border: "1px solid black", backgroundColor: "aliceblue", color: "red"}}>-350,000원</td>
            ...
            <tr>
                ...
                <td style={{ border: "1px solid black", backgroundColor: "aliceblue"}}>-</td>
                <td style={{ border: "1px solid black", backgroundColor: "aliceblue"}}>-</td>
                <td style={{ border: "1px solid black", backgroundColor: "aliceblue", color: "red"}}>-135,000원</td>
